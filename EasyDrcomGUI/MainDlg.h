...
public:
	...
	BEGIN_MSG_MAP(CMainDlg)
		...
		COMMAND_ID_HANDLER(IDC_BTN_SUPPORT2, OnSupportClickedMe)
		COMMAND_ID_HANDLER(IDC_BTN_SUPPORT3, OnSupportClicked3W)
...
//	LRESULT NotifyHandler(int /*idCtrl*/, LPNMHDR /*pnmh*/, BOOL& /*bHandled*/)
	...
	LRESULT OnSupportClickedMe(WORD /*wNotifyCode*/, WORD /*wID*/, HWND /*hWndCtl*/, BOOL& /*bHandled*/); //GDUFE
	LRESULT OnSupportClicked3W(WORD /*wNotifyCode*/, WORD /*wID*/, HWND /*hWndCtl*/, BOOL& /*bHandled*/); //GDUFE
